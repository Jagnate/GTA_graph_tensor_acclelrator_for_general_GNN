...
if __name__ == '__main__':
    ...
    #([[0], [2], [13], [3, 9, 10, 11, 12], [1, 4, 5, 6, 7, 8]], [[16, 1], [1536, 1], [768, 1], [1280, 1], [1408, 1]], 30722768, '0001011111001110')30722240
    #op_info = read('/Users/sijin/Desktop/workspace/GTA_Code/dataset/simpletest.yaml')
    
    # op_info = read('/Users/sijin/Desktop/workspace/GTA_Code/dataset/GAT_Cora.yaml')
    # hardware_info = load_inst_fused('/Users/sijin/Desktop/workspace/GTA_Code/template/hardware_info.yaml')
    # op_array = [[0], [2], [13], [3, 9, 10, 11, 12], [1, 4, 5, 6, 7, 8]]
    # tile_size_list = [[16, 1], [1536, 1], [768, 1], [1280, 1], [1408, 1]]
    # node_num = 2708

    # original-fused
    #([[0, 1, 2], [4, 5, 6, 7, 8], [3, 9, 10, 11, 12, 13]], [[128, 1], [2752, 1], [1152, 1]], 27155664, '1100011111001111')
    #([[0, 1, 2], [4, 5, 6, 7, 8], [3, 9, 10, 11, 12, 13]], [[1408, 1], [2752, 1], [2240, 1]], 7458048, '1100011111001111')
    #([[2], [3, 9, 10, 11, 12, 13], [0, 1, 4, 5, 6, 7, 8]], [[2752, 1], [2752, 1], [2752, 1]], 3783680, '1001011111001111')
    data_set = 'reddit'
    #node_num = 89250
    #node_num = 19717
    node_num = 232965
    ...
    #op_info = read('Network/PNA/PNA-cora/PNA-original/PNA-layer1-original.yaml')
    hardware_info = load_inst_fused('Code/hardware_info.yaml')
    inst_name = network+'-'+data_set+'-'+layer+'-'+op_map+'_1.yaml'
    ...
    for current_block_num in range(0,len(op_array)):
        ...
        TR = math.ceil(node_num/tile_size_list[current_block_num][0]/4)
        TC = math.ceil(node_num/tile_size_list[current_block_num][1]/4)
